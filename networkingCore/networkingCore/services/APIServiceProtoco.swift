...
public protocol APIServiceProtocol:AnyObject {
    //
    func getCurrentWeather(mGetCurrenWeatherReq:GetWeatherRequest, _ completion: @escaping (_ status:Int,_ current:String?,_ min:String?,_ max:String?,_ msg:String?,_ city:String) -> Swift.Void) -> Swift.Void
